...
//		Enter rate of intr=erest
		  fd.findElement(By.cssSelector("input#two")).sendKeys("10");
		
//		enter tenure
		  fd.findElement(By.cssSelector("div.frmbody>div:nth-of-type(3) input")).sendKeys("120");
